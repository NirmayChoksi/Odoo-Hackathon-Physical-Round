...
CREATE TABLE IF NOT EXISTS quotation_templates (
  ...
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  CONSTRAINT fk_template_plan FOREIGN KEY (plan_id) REFERENCES recurring_plans(plan_id)
    ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS quotation_template_items (
  ...
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  CONSTRAINT fk_template_items_template FOREIGN KEY (template_id) REFERENCES quotation_templates(template_id)
    ON DELETE CASCADE,
  CONSTRAINT fk_template_items_product FOREIGN KEY (product_id) REFERENCES products(product_id),
  CONSTRAINT fk_template_items_variant FOREIGN KEY (variant_id) REFERENCES product_variants(variant_id)
    ON DELETE SET NULL,
  CONSTRAINT fk_template_items_tax FOREIGN KEY (tax_id) REFERENCES taxes(tax_id)
    ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS subscriptions (
  ...
  status ENUM('DRAFT', 'QUOTATION', 'CONFIRMED', 'ACTIVE', 'CLOSED') DEFAULT 'DRAFT',
  ...
  CONSTRAINT fk_subscriptions_template FOREIGN KEY (template_id) REFERENCES quotation_templates(template_id)
    ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS subscription_items (
  ...
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  CONSTRAINT fk_subscription_items_subscription FOREIGN KEY (subscription_id) REFERENCES subscriptions(subscription_id)
    ON DELETE CASCADE,
  CONSTRAINT fk_subscription_items_product FOREIGN KEY (product_id) REFERENCES products(product_id),
  CONSTRAINT fk_subscription_items_variant FOREIGN KEY (variant_id) REFERENCES product_variants(variant_id)
    ON DELETE SET NULL,
  CONSTRAINT fk_subscription_items_tax FOREIGN KEY (tax_id) REFERENCES taxes(tax_id)
    ON DELETE SET NULL,
  CONSTRAINT fk_subscription_items_discount FOREIGN KEY (discount_id) REFERENCES discounts(discount_id)
    ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS discount_applications (
  ...
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT fk_discount_applications_discount FOREIGN KEY (discount_id) REFERENCES discounts(discount_id)
    ON DELETE CASCADE,
  CONSTRAINT fk_discount_applications_product FOREIGN KEY (product_id) REFERENCES products(product_id)
    ON DELETE CASCADE,
  CONSTRAINT fk_discount_applications_subscription FOREIGN KEY (subscription_id) REFERENCES subscriptions(subscription_id)
    ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS invoice_items (
  ...
  CONSTRAINT fk_invoice_items_tax FOREIGN KEY (tax_id) REFERENCES taxes(tax_id)
    ON DELETE SET NULL,
  CONSTRAINT fk_invoice_items_discount FOREIGN KEY (discount_id) REFERENCES discounts(discount_id)
    ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS invoice_taxes (
  ...
  CONSTRAINT fk_invoice_taxes_invoice FOREIGN KEY (invoice_id) REFERENCES invoices(invoice_id)
    ON DELETE CASCADE,
  CONSTRAINT fk_invoice_taxes_tax FOREIGN KEY (tax_id) REFERENCES taxes(tax_id)
    ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS subscription_history (
  ...
  remarks TEXT,
  CONSTRAINT fk_subscription_history_subscription FOREIGN KEY (subscription_id) REFERENCES subscriptions(subscription_id)
    ON DELETE CASCADE,
  CONSTRAINT fk_subscription_history_changed_by FOREIGN KEY (changed_by) REFERENCES users(user_id)
    ON DELETE SET NULL
);
